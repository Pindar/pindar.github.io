...
![Overview](/gitlab-kubernetes/idea_to_production_overview.svg)
...
![Overview](/gitlab-kubernetes/idea_to_production_branching.svg)
...
![Overview](/gitlab-kubernetes/idea_to_production_tools.svg)
...
1. Create your own repository and clone example repository https://github.com/Pindar/gcloud-k8s-express-app.git ![](/gitlab-kubernetes/screencapture-gitlab-projects-new-1488711395727.png){:width="100%"}
